...
class Contact extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            message: '',
            touched: {
                firstname: false, lastname: false, telnum: false, email: false,
            }
        };
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3) errors.firstname = 'Firstname should be >= 3 characters'; else if (this.state.touched.firstname && firstname.length > 10) errors.firstname = 'Firstname should be < 10 characters';

        if (this.state.touched.lastname && lastname.length < 3) errors.lastname = 'Lastname should be >= 3 characters'; else if (this.state.touched.lastname && lastname.length > 10) errors.lastname = 'Lastname should be < 10 characters';
